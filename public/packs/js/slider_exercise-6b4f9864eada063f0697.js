...
var sliderExercise = function sliderExercise() {
  ...
  var exerciseTime;
  var cs = new circle_slider__WEBPACK_IMPORTED_MODULE_1___default.a("#eslider", options);
...
// Module
exports.push([module.i, "#eslider {\n  /*\n    position: relative is needed for the handle to be\n    positioned correctly, and border-radius: 100% just\n    makes the div round.\n  */\n  position: relative;\n  border-radius: 100%;\n  /* Other than the above two, go wild! */\n  height: 300px;\n  width: 300px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: center;\n  font-size: 50px;\n  font-family: 'Comfortaa', cursive;\n  -webkit-border-image: url(\"http://www.photos-public-domain.com/wp-content/uploads/2012/05/mint-green-circle-patterned-plastic-texture.jpg\") 30/19px round;\n       -o-border-image: url(\"http://www.photos-public-domain.com/wp-content/uploads/2012/05/mint-green-circle-patterned-plastic-texture.jpg\") 30/19px round;\n          border-image: url(\"http://www.photos-public-domain.com/wp-content/uploads/2012/05/mint-green-circle-patterned-plastic-texture.jpg\") 30/19px round; }\n\n/*\n  Probably best to paste this exactly as is.\n  These CSS rules make sure that the handle rotates\n  properly, so don't change anything here.\n*/\n\n.cs-handle-container {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  height: 2px;\n  margin-top: -1px; }\n\n/* Also paste as is */\n\n.cs-handle {\n  position: absolute;\n  -webkit-transform: translateY(200%);\n          transform: translateY(200%); }\n\n/* the appearance of the handle, feel free to change! */\n\n#eslider .cs-handle {\n  height: 30px;\n  width: 30px;\n  /*\n    Change 'right' to change the offset from the edge.\n    E.g right: 0 puts the handle just next to the edge\n    of #slider, on the inside\n  */\n  right: -15px;\n  cursor: default;\n  border-radius: 100%;\n  box-shadow: rgba(0, 0, 0, 0.3) 0 1px 10px 0;\n  background-color: black; }\n\n#eslider .cs-handle:active {\n  background-color: black; }\n", "",{"version":3,"sources":["/Users/mel/code/melawein/lifeline/app/javascript/plugins/exercise/slider_exercise.scss","slider_exercise.scss"],"names":[],"mappings":"AAAA;EACE;;;;GCIC;EDCD,kBAAkB;EAClB,mBAAmB;EAEnB,uCAAA;EACA,aAAa;EACb,YAAY;EAEZ,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,gBAAgB;EAGhB,eAAe;EACf,iCAAiC;EAGnC,yJAAoJ;OAApJ,oJAAoJ;UAApJ,iJAAoJ,EAAA;;AAGpJ;;;;CCHC;;ADQD;EACE,kBAAkB;EAClB,OAAO;EACP,QAAQ;EACR,QAAQ;EACR,WAAW;EACX,gBAAgB,EAAA;;AAGlB,qBAAA;;AACA;EACE,kBAAkB;EAClB,mCAA2B;UAA3B,2BAA2B,EAAA;;AAG7B,uDAAA;;AACA;EACE,YAAY;EACZ,WAAW;EACX;;;;GCLC;EDUD,YAAY;EACZ,eAAe;EACf,mBAAmB;EAEnB,2CAA2C;EAC3C,uBAAuB,EAAA;;AAGzB;EAEE,uBAAuB,EAAA","file":"slider_exercise.scss","sourcesContent":["#eslider {\n  /*\n    position: relative is needed for the handle to be\n    positioned correctly, and border-radius: 100% just\n    makes the div round.\n  */\n  position: relative;\n  border-radius: 100%;\n\n  /* Other than the above two, go wild! */\n  height: 300px;\n  width: 300px;\n  // background: linear-gradient(90deg, $sleep, $sleep);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: center;\n  // background-color: #83b3b5 !important;\n  // border: 20px solid #83b3b5;\n  font-size: 50px;\n  font-family: 'Comfortaa', cursive;\n  // background-color: white;\n\nborder-image: url(\"http://www.photos-public-domain.com/wp-content/uploads/2012/05/mint-green-circle-patterned-plastic-texture.jpg\")  30 / 19px round;\n}\n\n/*\n  Probably best to paste this exactly as is.\n  These CSS rules make sure that the handle rotates\n  properly, so don't change anything here.\n*/\n.cs-handle-container {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  height: 2px;\n  margin-top: -1px;\n}\n\n/* Also paste as is */\n.cs-handle {\n  position: absolute;\n  transform: translateY(200%);\n}\n\n/* the appearance of the handle, feel free to change! */\n#eslider .cs-handle {\n  height: 30px;\n  width: 30px;\n  /*\n    Change 'right' to change the offset from the edge.\n    E.g right: 0 puts the handle just next to the edge\n    of #slider, on the inside\n  */\n  right: -15px;\n  cursor: default;\n  border-radius: 100%;\n  // background: linear-gradient(180deg, #FFFFFF, #efefef);\n  box-shadow: rgba(0, 0, 0, 0.3) 0 1px 10px 0;\n  background-color: black;\n}\n\n#eslider .cs-handle:active {\n  // background: linear-gradient(180deg, #EBEBEB, #DFDFDF)\n  background-color: black;\n}\n\n\n\n\n\n\n\n\n\n\n\n","#eslider {\n  /*\n    position: relative is needed for the handle to be\n    positioned correctly, and border-radius: 100% just\n    makes the div round.\n  */\n  position: relative;\n  border-radius: 100%;\n  /* Other than the above two, go wild! */\n  height: 300px;\n  width: 300px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: center;\n  font-size: 50px;\n  font-family: 'Comfortaa', cursive;\n  border-image: url(\"http://www.photos-public-domain.com/wp-content/uploads/2012/05/mint-green-circle-patterned-plastic-texture.jpg\") 30/19px round; }\n\n/*\n  Probably best to paste this exactly as is.\n  These CSS rules make sure that the handle rotates\n  properly, so don't change anything here.\n*/\n.cs-handle-container {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  height: 2px;\n  margin-top: -1px; }\n\n/* Also paste as is */\n.cs-handle {\n  position: absolute;\n  transform: translateY(200%); }\n\n/* the appearance of the handle, feel free to change! */\n#eslider .cs-handle {\n  height: 30px;\n  width: 30px;\n  /*\n    Change 'right' to change the offset from the edge.\n    E.g right: 0 puts the handle just next to the edge\n    of #slider, on the inside\n  */\n  right: -15px;\n  cursor: default;\n  border-radius: 100%;\n  box-shadow: rgba(0, 0, 0, 0.3) 0 1px 10px 0;\n  background-color: black; }\n\n#eslider .cs-handle:active {\n  background-color: black; }\n"]}]);
...
/******/ });
//# sourceMappingURL=slider_exercise-6b4f9864eada063f0697.js.map